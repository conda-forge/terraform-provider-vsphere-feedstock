...
validate_recipe_outputs "terraform-provider-vsphere-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="terraform-provider-vsphere-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi